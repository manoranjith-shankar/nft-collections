...
contract Crypto0x is ERC721Enumerable, Ownable {
    ...
    /**
      ...
      * name in our case is `Crypto0x` and symbol is `CX`.
      * Constructor for Crypto0x takes in the baseURI to set _baseTokenURI for the collection.
      * It also initializes an instance of whitelist interface.
      */
    constructor (address whitelistContract) ERC721("Crypto0x", "CX") {
